...
namespace API.models
{
    public class Transaction
    {
        ...
        public async Task<List<Transaction>> GetAllTransactionsAsync(){
            ...
            return await SelectShops(sql,parms);
        }

        //finds a shop for use in editing/deleting/searching
        public async Task<Shop> GetAshopAsync(string id){
            string sql ="";
            List<MySqlParameter> parms = new();
        ...
        public async Task insertTransactionAsync(Transaction myTransaction){
            ...
            await ShopsNoReturnSql(sql, parms);
        }
